...
public class GetPlantEndpoint : Endpoint<GetPlantRequest, PlantRecommendationDto>
{
    private readonly AgriDataContext _context;

    public GetPlantEndpoint(AgriDataContext context)
    {
        _context = context;
    }
    ...
    public override async Task HandleAsync(GetPlantRequest req, CancellationToken ct)
    {
        // query plant
